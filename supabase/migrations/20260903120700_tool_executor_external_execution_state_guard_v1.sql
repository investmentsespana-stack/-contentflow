-- Durable state-machine repair for tool_executor tasks with explicit execution recipes.
-- Prevents active external executions from being mislabeled as STATE_GUARD_BLOCKED_UNSPECIFIED.
