...
& $python -m py_compile "$Root\tradingview_futures_guard.py" "$Root\canonical_market_data.py" "$Root\asset_research.py" "$Root\Vibe-Codex-DeviceAuth.py" "$Root\vibe_full_preflight.py"
