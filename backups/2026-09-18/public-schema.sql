...
\restrict TxKRsBd3ghEmtZApTZhO7QkC1HDH9kedIpXikwbevHmqFP1kUa6ldvCBBeH6iLR
...
GRANT ALL ON FUNCTION public.trading_sqx_director_dispatch_v2(p_command_type text, p_project text, p_payload jsonb) TO anon;
GRANT ALL ON FUNCTION public.trading_sqx_director_dispatch_v2(p_command_type text, p_project text, p_payload jsonb) TO authenticated;
...
GRANT ALL ON FUNCTION public.trading_sqx_rara_verify_command() TO anon;
GRANT ALL ON FUNCTION public.trading_sqx_rara_verify_command() TO authenticated;
...
\unrestrict TxKRsBd3ghEmtZApTZhO7QkC1HDH9kedIpXikwbevHmqFP1kUa6ldvCBBeH6iLR
