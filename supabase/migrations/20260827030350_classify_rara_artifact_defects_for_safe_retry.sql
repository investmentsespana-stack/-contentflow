...
insert into public.contentflow_retry_policies(error_class,retryable,max_attempts,initial_backoff_seconds,backoff_coefficient,max_backoff_seconds,jitter_ratio,switch_model_on_retry) values ('artifact_defect',true,3,15,2,90,0.15,true) on conflict(error_class) do update set retryable=true,max_attempts=3,initial_backoff_seconds=15,backoff_coefficient=2,max_backoff_seconds=90,jitter_ratio=0.15,switch_model_on_retry=true;
