...
\restrict lGz0BHzm0rFLftlDoUcUOjUDQaT5hvYvmwMjoqKdHjZisQymPsOgPHUjK9qw8Mm
...
CREATE TABLE public.trading_sqx_bridge_commands (
    ...
    error text,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT trading_sqx_bridge_commands_command_type_check CHECK ((command_type = ANY (ARRAY['list_projects'::text, 'list_strategies'::text, 'list_databanks'::text, 'get_strategy_stats'::text, 'run_project'::text, 'stop_project'::text]))),
...
\unrestrict lGz0BHzm0rFLftlDoUcUOjUDQaT5hvYvmwMjoqKdHjZisQymPsOgPHUjK9qw8Mm
