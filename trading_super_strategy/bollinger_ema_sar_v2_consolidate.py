"""Consolidate per-market Bollinger/EMA/SAR V2 artifacts."""
...
ROOT = Path("bollinger_ema_sar_v2_downloads")
OUT = Path("bollinger_ema_sar_v2_crossmarket")
...
def main():
    ...
    result = {
        ...
        "single_change_vs_v1": "EMA20 5-bar net directional move >= 5% of Bollinger bandwidth; otherwise NO_TRADE",
