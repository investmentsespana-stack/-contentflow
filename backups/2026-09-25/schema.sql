...
\restrict h5yoS4XxNcW6fo3lwVrqK1Lloaa6MBtEfFJI838moLrfNKJSQ6YuExHAB5sW7z0
...
--
-- Name: backup_academy_20260828; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA backup_academy_20260828;
...
--
-- Name: function_defs; Type: TABLE; Schema: backup_academy_20260828; Owner: -
--

CREATE TABLE backup_academy_20260828.function_defs (
...
--
-- Name: manifest; Type: TABLE; Schema: backup_academy_20260828; Owner: -
--

CREATE TABLE backup_academy_20260828.manifest (
    id bigint NOT NULL,
...
--
-- Name: manifest_id_seq; Type: SEQUENCE; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE backup_academy_20260828.manifest ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME backup_academy_20260828.manifest_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: project_rows; Type: TABLE; Schema: backup_academy_20260828; Owner: -
--

CREATE TABLE backup_academy_20260828.project_rows (
...
--
-- Name: project_rows_id_seq; Type: SEQUENCE; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE backup_academy_20260828.project_rows ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME backup_academy_20260828.project_rows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: related_rows; Type: TABLE; Schema: backup_academy_20260828; Owner: -
--

CREATE TABLE backup_academy_20260828.related_rows (
    table_name text NOT NULL,
    row_data jsonb NOT NULL,
    id bigint NOT NULL
);
...
--
-- Name: related_rows_id_seq; Type: SEQUENCE; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE backup_academy_20260828.related_rows ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME backup_academy_20260828.related_rows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: contentflow_control_leases; Type: TABLE; Schema: private; Owner: -
--

CREATE TABLE private.contentflow_control_leases (
    project_key text NOT NULL,
...
--
-- Name: contentflow_pg_net_watchdog_state; Type: TABLE; Schema: private; Owner: -
--

CREATE TABLE private.contentflow_pg_net_watchdog_state (
    id integer DEFAULT 1 NOT NULL,
    queue_count integer DEFAULT 0 NOT NULL,
    min_request_id bigint,
    max_request_id bigint,
    first_seen_at timestamp with time zone,
    last_seen_at timestamp with time zone,
    last_restart_at timestamp with time zone,
    restart_count bigint DEFAULT 0 NOT NULL,
    CONSTRAINT contentflow_pg_net_watchdog_state_id_check CHECK ((id = 1))
);


--
-- Name: meta_oauth_tokens; Type: TABLE; Schema: private; Owner: -
--

CREATE TABLE private.meta_oauth_tokens (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: TABLE meta_oauth_tokens; Type: COMMENT; Schema: private; Owner: -
--
...
--
-- Name: function_defs function_defs_pkey; Type: CONSTRAINT; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE ONLY backup_academy_20260828.function_defs
    ADD CONSTRAINT function_defs_pkey PRIMARY KEY (function_identity);


--
-- Name: manifest manifest_pkey; Type: CONSTRAINT; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE ONLY backup_academy_20260828.manifest
    ADD CONSTRAINT manifest_pkey PRIMARY KEY (id);


--
-- Name: project_rows project_rows_pkey; Type: CONSTRAINT; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE ONLY backup_academy_20260828.project_rows
    ADD CONSTRAINT project_rows_pkey PRIMARY KEY (id);


--
-- Name: related_rows related_rows_pkey; Type: CONSTRAINT; Schema: backup_academy_20260828; Owner: -
--

ALTER TABLE ONLY backup_academy_20260828.related_rows
    ADD CONSTRAINT related_rows_pkey PRIMARY KEY (id);


--
-- Name: contentflow_control_leases contentflow_control_leases_pkey; Type: CONSTRAINT; Schema: private; Owner: -
--

ALTER TABLE ONLY private.contentflow_control_leases
    ADD CONSTRAINT contentflow_control_leases_pkey PRIMARY KEY (project_key);


--
-- Name: contentflow_pg_net_watchdog_state contentflow_pg_net_watchdog_state_pkey; Type: CONSTRAINT; Schema: private; Owner: -
--

ALTER TABLE ONLY private.contentflow_pg_net_watchdog_state
    ADD CONSTRAINT contentflow_pg_net_watchdog_state_pkey PRIMARY KEY (id);


--
-- Name: meta_oauth_tokens meta_oauth_tokens_pkey; Type: CONSTRAINT; Schema: private; Owner: -
--

ALTER TABLE ONLY private.meta_oauth_tokens
    ADD CONSTRAINT meta_oauth_tokens_pkey PRIMARY KEY (id);


--
-- Name: meta_oauth_tokens meta_oauth_tokens_provider_app_id_page_id_key; Type: CONSTRAINT; Schema: private; Owner: -
--

ALTER TABLE ONLY private.meta_oauth_tokens
    ADD CONSTRAINT meta_oauth_tokens_provider_app_id_page_id_key UNIQUE (provider, app_id, page_id);
...
\unrestrict h5yoS4XxNcW6fo3lwVrqK1Lloaa6MBtEfFJI838moLrfNKJSQ6YuExHAB5sW7z0
