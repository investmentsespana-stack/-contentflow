"""Consolidate per-market Bollinger/EMA/SAR V3 artifacts."""
...
ROOT = Path("bollinger_ema_sar_v3_downloads")
OUT = Path("bollinger_ema_sar_v3_crossmarket")
...
def main():
    ...
    cols = ["symbol","direction","session","pattern","ema9_20_phase","net_r","exit_reason","entry_time_et"]
    ...
    result = {
        ...
        "single_change_vs_v1": "EMA3 and EMA9 must slope in trade direction on the signal-bar 3/9 cross; no pre-existing EMA20 slope gate.",
